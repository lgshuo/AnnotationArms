...
public class FragNavController {
    ...
    /**
     *
     * @param transactionListener        A listener to be implemented (typically within the main activity) to fragment transactions (including tab_background switches);
     */
    ...
    /**
     * Pop the current fragment from the current tab_background
     */
    public void pop() {
    ...
    /**
     * Clears the current tab_background's stack to get to just the bottom Fragment. This will reveal the root fragment,
     */
